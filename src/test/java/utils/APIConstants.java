...
public class APIConstants {
    ...
    public static final String ONE_EMPLOYEE_URI =BaseURI+"/getOneEmployee.php";
    ...
    public static final String PARTIALLY_UPDATE_EMPLOYEES_URI =BaseURI+"/updatePartialEmplyeesDetails.php";
